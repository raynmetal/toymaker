...
#ifndef TOYMAKERENGINE_SPATIALQUERYSYSTEM_H
#define TOYMAKERENGINE_SPATIALQUERYSYSTEM_H
...
namespace ToyMaker {
    ...
    public:
         ...
         *
         * @todo This sort of makes it so that an object with LightEmissionData and StaticModel components gets conflicting results for ObjectBounds.
